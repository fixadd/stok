...
DDL = [
    """CREATE TABLE IF NOT EXISTS configuration_rules (
        id SERIAL PRIMARY KEY, entity_type VARCHAR(64) NOT NULL, field_key VARCHAR(128) NOT NULL,
        rule_type VARCHAR(32) NOT NULL, rule_json JSONB NOT NULL DEFAULT '{}'::jsonb,
    ...
    """CREATE TABLE IF NOT EXISTS lookup_dependencies (
        id SERIAL PRIMARY KEY, parent_key VARCHAR(128) NOT NULL, child_key VARCHAR(128) NOT NULL,
        mapping_json JSONB NOT NULL DEFAULT '{}'::jsonb, active BOOLEAN NOT NULL DEFAULT TRUE,
        created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    """CREATE TABLE IF NOT EXISTS report_definitions (
        ...
        entity_type VARCHAR(64) NOT NULL, definition_json JSONB NOT NULL DEFAULT '{}'::jsonb,
    ...
    """CREATE TABLE IF NOT EXISTS notification_rules (
        id SERIAL PRIMARY KEY, key VARCHAR(128) NOT NULL UNIQUE, label VARCHAR(160) NOT NULL,
        event_key VARCHAR(128) NOT NULL, channel VARCHAR(32) NOT NULL DEFAULT 'web', target_json JSONB NOT NULL DEFAULT '{}'::jsonb,
        condition_json JSONB NOT NULL DEFAULT '{}'::jsonb, active BOOLEAN NOT NULL DEFAULT TRUE,
        created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
    )""",
    "CREATE INDEX IF NOT EXISTS ix_notification_rules_event ON notification_rules(event_key, active)",
    """CREATE TABLE IF NOT EXISTS api_tokens (
        id SERIAL PRIMARY KEY, name VARCHAR(160) NOT NULL, token_hash VARCHAR(128) NOT NULL UNIQUE,
        user_id INTEGER REFERENCES users(id) ON DELETE SET NULL, active BOOLEAN NOT NULL DEFAULT TRUE,
        last_used_at TIMESTAMP, created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
    )""",
