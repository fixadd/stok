...
def load_tracking_payload(*, serialize_item: Callable[[Any], dict[str, Any]]) -> dict[str, Any]:
    """Build the inventory tracking page payload.

    Database access is delegated to query modules; presentation serialization is
    injected so this service does not depend on Flask's application module.
    """
