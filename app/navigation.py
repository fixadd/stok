...
NAV_ITEMS: dict[str, dict[str, Any]] = {
    ...
    "personnel_lifecycle": {
        "title": "Personel Lifecycle",
        "endpoint": "personnel_lifecycle.list_page",
        "icon": "bi-people",
        "min_role": "user",
        "parent": "index",
        "section": "operations",
